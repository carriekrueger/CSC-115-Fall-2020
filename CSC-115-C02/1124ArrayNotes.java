...
public class ArrayNotes {
    public static void main(String[] args) {
        ...
        */ 
        ...
        // print the last element in the array - position 6 (seventh element)
        
        System.out.println("Last: " + temps[6]); 
        
        // position 7? 
        
        //System.out.println(temps[7]); // ArrayIndexOutOBounds error 
        
        // print the last element in any aray - position length - 1 
        ...
        System.out.println(); // next thing prints on the next line 
    ...
    // note: when you send an array as a parameter, if you change the array in 
    // the method, the changes stick after the method ends (not changing anything here)
