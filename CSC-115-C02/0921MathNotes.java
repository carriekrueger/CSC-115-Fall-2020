...
public class MathNotes {
    ...
    public static void doMath() {
        ...
        // casting is temporarily turning one variable type into another
        // PEMDAS at work...
        ...
        double pay = 500.92;
        System.out.println((int)pay); // 500? 501?  --> 500! 
        ...
        // can send information/variables in ( ) 
        
        // round:  Math.round(double num) 
        // returns (gives) a long, but need to cast to an int 
        ...
        // EXPONENTS (POWERS)
        // ex. num1 squared? 
        // computer doesn't understand ( ) for multiply, or ^
        // num1 * num1 
        // OR Math.pow(base, exponent)  **returns a double 
