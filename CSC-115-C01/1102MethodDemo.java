...
public class MethodDemo {
        ...
        public static void main(String[] args) {
            ...
            if(choice == 4) {
             ...
             //   System.out.println(answer);   // saving it to a variable
                
                System.out.println(exp(num1,num2)); // return to 
                                                    // a print statement
        ...
        public static int exp(int a, int b) {
            ...
            // return Math.pow(a, b);  cheat code... would have to change
            //                         the return type to double 
